# Homework-Project-101 : Working with AMI&Snapshots on EC2 instances and Additional Volumes
...
Part 4 - Create an new volume (15 GiB) from additional volume's snapshop of EC2-A

Part 5 - Create an instance (EC2-B) from root volume's snapshop of EC2-A

Part 6 - Launch EC2-B and mount the additional volume (15 GiB) (created on Part 4)

## Part 1 - Creating an EC2 instance (EC2-A) with an additional volume (10 GiB)

-  Launch an instance name EC2-A with following configurations.
