...
app.config['MYSQL_DATABASE_HOST'] = 'fevzi-rds-mysql-database.cq0wf2quqgug.us-east-1.rds.amazonaws.com'
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=80) # ec2 dan çalışacak hale getirdik
    # app.run(debug=True)
